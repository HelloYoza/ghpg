...
export const metadata = {
  title: 'Ghan Property Group - Development Management',
};
      ...
      <section className="w-full bg-white py-16">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center">
            <h3 className="text-3xl font-bold text-gray-900 mb-8">Comprehensive Development Management</h3>
            <p className="text-gray-700 leading-relaxed mb-6 text-lg">
              Our development management services provide end-to-end support for your construction and development projects. We handle every aspect from initial planning through to final completion, ensuring seamless execution and successful delivery.
            </p>
            <p className="text-gray-700 leading-relaxed mb-6 text-lg">
              Our experienced team manages site due diligence, development planning, town planning approvals, design development, construction phases, and financial management. We coordinate with contractors, consultants, and regulatory bodies to keep your project on track.
            </p>
            <p className="text-gray-700 leading-relaxed text-lg">
              With our comprehensive approach and attention to detail, we minimize risks, optimize costs, and ensure quality outcomes. Let us manage the complexities of your development project while you focus on your core business objectives.
            </p>
          </div>
        </div>
      </section>
