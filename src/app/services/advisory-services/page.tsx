...
export const metadata = {
  title: 'Ghan Property Group - Advisory Services',
};
      ...
      <section className="w-full bg-white py-16">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center">
            <h3 className="text-3xl font-bold text-gray-900 mb-8">Expert Advisory Services</h3>
            <p className="text-gray-700 leading-relaxed mb-6 text-lg">
              Our advisory services provide strategic guidance and expert consultation to help you make informed decisions throughout your development journey. We offer comprehensive analysis and recommendations tailored to your specific needs and objectives.
            </p>
            <p className="text-gray-700 leading-relaxed mb-6 text-lg">
              Our experienced advisors work closely with you to assess opportunities, identify potential risks, and develop strategies that align with your business goals. We provide insights on market conditions, regulatory requirements, and best practices in the industry.
            </p>
            <p className="text-gray-700 leading-relaxed text-lg">
              Whether you need guidance on feasibility studies, investment analysis, or strategic planning, our advisory services deliver the expertise and support you need to make confident decisions and achieve successful outcomes.
            </p>
          </div>
        </div>
      </section>
